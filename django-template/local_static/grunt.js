...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    mincss: {
      "dist/release/index.css": [
        "assets/vendor/typicons/css/*.css",
        "assets/vendor/jquery-ui/css/*.css",
        "assets/vendor/bootstrap/css/*.css",
        "assets/css/**/*.css",
      ]
    },
    ...
    copy: {
      dist: {
        ...
        files: {
          "dist/img": [
            "assets/vendor/bootstrap/img/*",
            "assets/vendor/jquery-ui/img/*",
            "assets/img/*",
           ],
           "dist/fonts": [
            "assets/vendor/typicons/fonts/*",
           ],
           "dist/assets/img/in_html": [
            "assets/img/in_html/*",
          ]
        }
      },
  ...
  grunt.registerTask("release", "clean jst requirejs concat min mincss copy");
